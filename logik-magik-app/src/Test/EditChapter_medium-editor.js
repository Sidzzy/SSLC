...
//   } 
  ...
  componentDidMount () {
    ...
    //     console.log(this.state)
    // })
    const display = new MediumEditor(".medium-display",{ 
        text: this.state.text
    });
  }
    render() {
      ...
      <div className="row animated fadeInUp" data-animation="fadeInUp-fadeOutDown">
          <div id="main-post" className="col-xs-10 col-md-8 col-md-offset-2 col-xs-offset-1 main-content">
              <div className="post-metadata">
                  {/* <img alt={this.state.text} className="avatar-image" src={this.state.text} height="40" width="40" /> */}
                  {/* <div className="post-info">
                      <div data-react-className="PopoverLink" data-react-props="{&quot;user_id&quot;:608,&quot;url&quot;:&quot;/users/netk&quot;,&quot;children&quot;:&quot;netk&quot;}"><span className="popover-link" data-reactroot=""><a href="">{this.state.text}</a></span></div>
              ...
              <form className="editor-form main-editor" autocomplete="off" >
                ...
                <div className="form-group">
                  <textarea id="medium-display" className="medium-editable" ></textarea>
                </div>
              <div class="hidden">
